...
const ConnectedEducationForm = () => (
	<Consumer>
		{value => <EducationForm educationId={value.pageConstants.educationId} showPage={value.showPage} editPage={value.editPage}
														 page={value.page} handleChange={value.handleChange}/>}
	</Consumer>
);
export default ConnectedEducationForm;