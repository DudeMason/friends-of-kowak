...
const ConnectedCommunityForm = () => (
	<Consumer>
		{value => <CommunityForm communityId={value.pageConstants.communityId} showPage={value.showPage} editPage={value.editPage}
														 page={value.page} handleChange={value.handleChange}/>}
	</Consumer>
);
export default ConnectedCommunityForm;